...
package com.michel.adrien.testslidingbar;
...
public class MainActivity extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mwebTitles = getResources().getStringArray(R.array.webs_array);
        ...
        mDrawerList.setAdapter(new ArrayAdapter<String>(this,
                R.layout.drawer_list_item, mwebTitles));
    ...
    private void selectItem(int position) {
        ...
        WebViewFragment fragment = new WebFragment();
        Bundle args = new Bundle();
        args.putInt(WebFragment.ARG_WEB_NUMBER, position);
